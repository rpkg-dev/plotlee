...
[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/rpkg-dev/plotlee)
...
- R source code is *not* split over several files as [suggested by the TSG](https://style.tidyverse.org/package-files.html) but instead is (as far as possible) kept in the single file [`Rmd/plotlee.Rmd`](https://gitlab.com/rpkg.dev/plotlee/-/tree/master/Rmd/plotlee.Rmd) which is well-structured thanks to its [Markdown support](#r-markdown-format).
